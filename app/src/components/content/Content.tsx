    ...
    <div className="content">
      <div className="theme">
        <img
          src={
            theme === 'black'
              ? './resume-site/src/assets/img/white-theme.png'
              : './resume-site/src/assets/img/black-theme.png'
          }
      ...
      <section id="expirience" className="expirience hidden">
        ...
        <div className="timeline">
          <div className="container left-container">
            <img src="./resume-site/src/assets/img/school.png" alt="bmstu" />
          ...
          <div className="container right-container">
            <img src="./resume-site/src/assets/img/vk.png" alt="vk" />
            <div className="text-box">
              <span className="text-h4-medium expirience__company__name">
                VK Образование
              </span>
      ...
      <section id="contact" className="contact hidden">
        ...
        <div className="contact__items">
          <div className="contact__item contact__telegram hidden">
            ...
            >
              <img
                src="./resume-site/src/assets/img/telegram.png"
          ...
          <div className="contact__item contact__vk hidden">
            ...
            >
              <img
                src="./resume-site/src/assets/img/vk2.png"
                className="contact__item-img"
              />
            </a>
          </div>
          <div className="contact__item contact__mailru hidden">
            ...
            >
              <img
                src="./resume-site/src/assets/img/mailru.png"
                className="contact__item-img"
              />
            </a>
          </div>
          <div className="contact__item contact__phone hidden">
            ...
            >
              <img
                src="./resume-site/src/assets/img/phone.png"
                className="contact__item-img"
                alt="Phone Icon"
              />
            </a>
